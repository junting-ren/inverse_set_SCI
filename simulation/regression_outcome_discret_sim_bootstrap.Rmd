---
title: "Simulation_analysis_regression_discrete_outcome"
author: "Junting Ren"
date: "12/5/2021"
...
N_pred =c(100, 500, 1000, 2000, 5000, 10000)# number of predictions to do 
...
result_df_linear = data.frame(N_pred =N_pred,
...
result_df_logistic = data.frame(N_pred =N_pred,
           Upper5 = upper5_contain_v,
           Upper10 = upper10_contain_v,
           Upper25 = upper25_contain_v,
           Upper50 = upper50_contain_v,
...
result_df_logistic
if(write){
  save.image("regression_outcome__discrete_bootstrap.RData")
}
```
